...
namespace ModbusMqttPublisher.Tests.Tests.Domain
{
    public class ValueTests
    {
        ...
        public static IEnumerable<object[]> FromModbusNumericTestData(bool fromTest = false)
        {
            ...
            yield return new object[] { RegisterFormat.Uint32, new ushort[] { 0xFF85, 0xFFF0 }.Reverse().ToArray(), "4293984133" };
            yield return new object[] { RegisterFormat.Int32, new ushort[] { 0xFF85, 0xFFF0 }.Reverse().ToArray(), "-983163" };
            yield return new object[] { RegisterFormat.Uint64, new ushort[] { 0xFF85, 0xFFF0, 0xFFFF, 0xFFF1 }.Reverse().ToArray(), "18442803424034619269" };
            yield return new object[] { RegisterFormat.Int64, new ushort[] { 0xFF85, 0xFFF0, 0xFFFF, 0xFFF1 }.Reverse().ToArray(), "-3940649674932347" };

            yield return new object[] { RegisterFormat.Uint32LE, new ushort[] { 0xFF85, 0xFFF0 }, "4293984133" };
            yield return new object[] { RegisterFormat.Int32LE, new ushort[] { 0xFF85, 0xFFF0 }, "-983163" };
            yield return new object[] { RegisterFormat.Uint64LE, new ushort[] { 0xFF85, 0xFFF0, 0xFFFF, 0xFFF1 }, "18442803424034619269" };
            yield return new object[] { RegisterFormat.Int64LE, new ushort[] { 0xFF85, 0xFFF0, 0xFFFF, 0xFFF1 }, "-3940649674932347" };

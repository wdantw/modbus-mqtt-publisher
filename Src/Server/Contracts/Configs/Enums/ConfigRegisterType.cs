namespace ModbusMqttPublisher.Server.Contracts.Configs.Enums
{
    public enum ConfigRegisterType
    {
        ...
        HoldingRegister32LE = RegisterType.HoldingRegister | RegisterFormat.Uint32LE << _TypeBitCount,
        HoldingRegister64LE = RegisterType.HoldingRegister | RegisterFormat.Uint64LE << _TypeBitCount,
        ...
        HoldingRegisterS32LE = RegisterType.HoldingRegister | RegisterFormat.Int32LE << _TypeBitCount,
        HoldingRegisterS64LE = RegisterType.HoldingRegister | RegisterFormat.Int64LE << _TypeBitCount,
        ...
        InputRegister32LE = RegisterType.InputRegister | RegisterFormat.Uint32LE << _TypeBitCount,
        InputRegister64LE = RegisterType.InputRegister | RegisterFormat.Uint64LE << _TypeBitCount,
        ...
        InputRegisterS32LE = RegisterType.InputRegister | RegisterFormat.Int32LE << _TypeBitCount,
        InputRegisterS64LE = RegisterType.InputRegister | RegisterFormat.Int64LE << _TypeBitCount,
